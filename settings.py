...
ENV_TO_SETTINGS_MAP = {
    ...
    "PROVIDER_MEMORY_CACHE_ENABLED": "provider_memory_cache_enabled",
    "PROVIDER_MEMORY_CACHE_MAX_ENTRIES": "provider_memory_cache_max_entries",
    ...
    "PROVIDER_TICKER_DATA_CACHE_TTL_SECONDS": "provider_ticker_data_cache_ttl_seconds",
...
def get_safe_settings_summary() -> dict[str, object]:
    ...
    return {
        ...
        "provider_memory_cache_enabled": settings.get("provider_memory_cache_enabled"),
        "provider_memory_cache_max_entries": settings.get("provider_memory_cache_max_entries"),
        ...
        "provider_ticker_data_cache_ttl_seconds": settings.get("provider_ticker_data_cache_ttl_seconds"),
