...
from backend.repositories.sqlite_ticket_repository import SQLiteTicketRepository
...
def get_ticket_repository() -> SQLiteTicketRepository:
    return SQLiteTicketRepository(_default_scan_database_path())